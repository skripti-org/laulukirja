...
const IndexPage = ({ data, location }) => {
  ...
  return (
    <Layout location={location} title={siteTitle}>
      ...
      <hr />
      <p>
        Voit pyytää puheenvuoroa nousemalla seisomaan. Kun Toastmaster antaa
        sinulle luvan puhua esittele itsesi kuta kuinkin näin: ”Arvon
        Toastmasterit, ja arvoisa sitsikansa minun nimeni on …” Esittelyn
        jälkeen voit vastata mahdollisiin sitsikansan esittämiin kysymyksiin
        sekä kertoa asiasi/toivoa laulua jne. jne.
      </p>
      ...
      <hr />
      <p>
        Voit halutessasi huutaa laulujen säkeistöjen välissä seuraavia
        huudahduksia:
      </p>
      <ul style={{ listStylePosition: "inside" }}>
        ...
        <li>OM START = Aloitetaan meneillään oleva säkeistö alusta</li>
      </ul>
      ...
      <p>
        ...
        lopuksi vastapäätä istuvan henkilön kanssa. Skoolaus voi myös tapahtua
        vinottain: esim. ensin vinoon oikealle, sitten vasemmalle ja lopuksi
        vastapäätä.
      </p>
      ...
      <div>
        <p>
          ÄLÄ KÄYTÄ PUHELINTA mihinkään muuhun kuin sähköisen lauluvihkon
          selaamiseen.
        </p>
        <p>ÄLÄ TAPUTA vaan hakkaa pöytää.</p>
        <p>Pöydästä saa nousta vain Toastien luvalla.</p>
        <p>Sääntöjen rikkomisesta seuraa ankaria rangaistuksia.</p>
      </div>
      <hr />
